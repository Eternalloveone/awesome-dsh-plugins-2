...
| `audit-results.csv` | **2026-08-14 批量审计日志**：对 417 个候选仓库逐一核验的完整记录（判定、理由、能力、安装命令、许可证、风险、证据）。325 个符合条件者已升入 `verified-plugins.csv`，其余为 watchlist / rejected。 / **2026-08-14 batch audit log**: one row per candidate repo with verdict, reason, capability, install command, license, risk, and evidence. 325 qualifying repos were promoted to `verified-plugins.csv`; the rest are watchlist/rejected. |
