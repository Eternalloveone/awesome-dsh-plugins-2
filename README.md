...
> 该分类共 **16** 个已核验条目，[查看完整清单 →](docs/categories/mcp.md)
...
> 该分类共 **202** 个已核验条目，[查看完整清单 →](docs/categories/agents-workflows.md)
...
> 该分类共 **211** 个已核验条目，[查看完整清单 →](docs/categories/developer-tools.md)
...
| [Weaxs/stock-analysis-plugin](https://github.com/Weaxs/stock-analysis-plugin) | Multi-market stock analysis, factor selection and strategy backtesting as DSH skills (20 skills: comprehensive analysis, full-market selection, backtests + 17 strategy methodologies) | `dsh plugin --profile web add @weaxs/dsh-stock-analysis` | 未发现；Pulls market data from external sources (some need API tokens); analysis only, no order execution; Python deps installed via postinstall |
...
> 该分类共 **75** 个已核验条目，[查看完整清单 →](docs/categories/media-vision.md)
